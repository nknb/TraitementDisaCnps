...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.traitement_btn_1 = QtWidgets.QPushButton(self.icon_only_widget)
        self.traitement_btn_1.setText("")
        icon2 = QtGui.QIcon()
        ...
        self.traitement_btn_1.setIcon(icon2)
        self.traitement_btn_1.setIconSize(QtCore.QSize(20, 20))
        self.traitement_btn_1.setCheckable(True)
        self.traitement_btn_1.setAutoExclusive(True)
        self.traitement_btn_1.setObjectName("traitement_btn_1")
        self.verticalLayout.addWidget(self.traitement_btn_1)
        self.database_btn_1 = QtWidgets.QPushButton(self.icon_only_widget)
        self.database_btn_1.setText("")
        icon3 = QtGui.QIcon()
        ...
        self.database_btn_1.setIcon(icon3)
        self.database_btn_1.setIconSize(QtCore.QSize(20, 20))
        self.database_btn_1.setCheckable(True)
        self.database_btn_1.setAutoExclusive(True)
        self.database_btn_1.setObjectName("database_btn_1")
        self.verticalLayout.addWidget(self.database_btn_1)
        self.users_btn_1 = QtWidgets.QPushButton(self.icon_only_widget)
        self.users_btn_1.setText("")
        icon4 = QtGui.QIcon()
        ...
        self.users_btn_1.setIcon(icon4)
        self.users_btn_1.setIconSize(QtCore.QSize(20, 20))
        self.users_btn_1.setCheckable(True)
        self.users_btn_1.setAutoExclusive(True)
        self.users_btn_1.setObjectName("users_btn_1")
        self.verticalLayout.addWidget(self.users_btn_1)
        ...
        self.traitement_btn_2 = QtWidgets.QPushButton(self.full_menu_widget)
        self.traitement_btn_2.setIcon(icon2)
        self.traitement_btn_2.setIconSize(QtCore.QSize(14, 14))
        self.traitement_btn_2.setCheckable(True)
        self.traitement_btn_2.setAutoExclusive(True)
        self.traitement_btn_2.setObjectName("traitement_btn_2")
        self.verticalLayout_2.addWidget(self.traitement_btn_2)
        self.database_btn_2 = QtWidgets.QPushButton(self.full_menu_widget)
        self.database_btn_2.setIcon(icon3)
        self.database_btn_2.setIconSize(QtCore.QSize(14, 14))
        self.database_btn_2.setCheckable(True)
        self.database_btn_2.setAutoExclusive(True)
        self.database_btn_2.setObjectName("database_btn_2")
        self.verticalLayout_2.addWidget(self.database_btn_2)
        self.users_btn_2 = QtWidgets.QPushButton(self.full_menu_widget)
        self.users_btn_2.setIcon(icon4)
        self.users_btn_2.setIconSize(QtCore.QSize(14, 14))
        self.users_btn_2.setCheckable(True)
        self.users_btn_2.setAutoExclusive(True)
        self.users_btn_2.setObjectName("users_btn_2")
        self.verticalLayout_2.addWidget(self.users_btn_2)
        ...
        self.traitement_btn_1.toggled['bool'].connect(self.traitement_btn_2.setChecked) # type: ignore
        self.database_btn_1.toggled['bool'].connect(self.database_btn_2.setChecked) # type: ignore
        self.users_btn_1.toggled['bool'].connect(self.users_btn_2.setChecked) # type: ignore
        ...
        self.traitement_btn_2.toggled['bool'].connect(self.traitement_btn_1.setChecked) # type: ignore
        self.database_btn_2.toggled['bool'].connect(self.database_btn_1.setChecked) # type: ignore
        self.users_btn_2.toggled['bool'].connect(self.users_btn_1.setChecked) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "R-Disa"))
        self.logo_label_3.setText(_translate("MainWindow", "R-Disa"))
        self.home_btn_2.setText(_translate("MainWindow", "Accueil"))
        self.dashborad_btn_2.setText(_translate("MainWindow", "Tableau de bord"))
        self.traitement_btn_2.setText(_translate("MainWindow", "Import Excel"))
        self.database_btn_2.setText(_translate("MainWindow", "Base de données"))
        self.users_btn_2.setText(_translate("MainWindow", "Utilisateurs"))
        self.exit_btn_2.setText(_translate("MainWindow", "Quitter"))
        self.search_input.setPlaceholderText(_translate("MainWindow", "Rechercher..."))
        self.label_4.setText(_translate("MainWindow", "Page d'accueil"))
        self.label_5.setText(_translate("MainWindow", "Page tableau de bord"))
        self.label_6.setText(_translate("MainWindow", "Import Excel"))
        self.label_7.setText(_translate("MainWindow", "Base de données"))
        self.label_8.setText(_translate("MainWindow", "Utilisateurs - Gestion des utilisateurs"))
        self.label_9.setText(_translate("MainWindow", "Page de recherche"))
        self.label_10.setText(_translate("MainWindow", "Page utilisateur"))
